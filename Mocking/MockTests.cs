...
namespace Mocking
{
    ...
    public class MockTests
    {
        ...
        public void CanCalulateAverageWeeklySaleryPerEmployee()
        {
            ...
            var mock = new Mock<IEmployeeRepository>();
            mock.Setup(m => m.LoadEmployee(1)).Returns(() => new Employee() { Id = 1, Name = "Constantin", Type = "Driver", Wage = 50 });
            mock.Setup(m => m.LoadEmployee(2)).Returns(() => new Employee() { Id = 2, Name = "Alin", Type = "Mechanic", Wage = 100 });

            Employee e = mock.Object.LoadEmployee(1);
            Employee e2 = mock.Object.LoadEmployee(2);

            Assert.AreEqual("Constantin", e.Name);
            Assert.AreEqual("Alin", e2.Name);
